 ...
 */
 ...
 //var THREE = require('./third-party/three.min')
 var THREE = require('three')
var SPE = require('../ShaderParticleEngine/ShaderParticles.js')
...
//        size = data[i + 2];
  ...
  function addBox(lat, lng, size) {
    ...
    box.position.x = 200 * Math.sin(phi) * Math.cos(theta);
    box.position.y = 200 * Math.cos(phi);
    box.position.z = 200 * Math.sin(phi) * Math.sin(theta);
