...
class TheScheduled extends React.Component {
  ...
  render () {
    ...
    <TilingSprite filters={new PIXI.filters.BlurFilter()}  image={"data:image/jpeg;base64," + img} width={width} height={height} key="1" />
    <Text text="Vector text" x={50} y={10} anchor={new PIXI.Point(1.5,0)} key="2" />
    </Stage>;
